...
using NobleActionCatSet = Set<LNobleActionCat>;
using NobleActionCatSetIterator = SetIterator<LNobleActionCat>;
using NobleActionCatSetInsertIterator = Pair<NobleActionCatSetIterator, bool>;
