                                                    ...
                                                    game::IMidScenarioObject* obj)
{
    ...
    auto dragDropInterf = &thisptr->dragDropInterf;
    if (dragDropInterf->dragAndDropInterfData->currentSource) {
        dragDropInterf->dragAndDropInterfData->currentSource = nullptr;
